(custom-set-variables
 ...
 '(fic-highlighted-words '("FIXME" "TODO" "BUG" "REDFLAG" "XXX"))
 '(fill-column 80)
 '(flycheck-checkers
...
")
 ...
 '(semanticdb-project-roots '("/usr/www/tagasauris/"))
 ...
 '(tool-bar-mode nil)
 '(tramp-backup-directory-alist '(("." . "~/.saves")) nil (tramp))
...
(custom-set-faces
 ...
 '(show-paren-match-expression ((t (:inherit show-paren-match :background "gray19"))))
