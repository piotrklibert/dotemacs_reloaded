...
;;;###autoload
(defun mark-lines-previous-line (&optional arg)
...
Otherwise arg is treated exactly as `previous-line'."
  (interactive "P")
  (mark-lines--move 'previous-line (or arg 1)))


;;;###autoload
(defun mark-lines-next-line (&optional arg)
  "same as `mark-lines-previous-line', going in the other direction."
  (interactive "P")
  (mark-lines--move 'next-line (or arg 1)))
